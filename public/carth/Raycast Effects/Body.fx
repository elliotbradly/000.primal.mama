...
#define NORMAL_MAP_FILE "bodynormal.png"

const float normalMapScale = 1.50;
const float normalMapLoopNum = 1.0;

#define NORMAL_SUB_MAP_FROM 0
#define NORMAL_SUB_MAP_TYPE 0
#define NORMAL_SUB_MAP_UV_FLIP 0
#define NORMAL_SUB_MAP_FILE "skinnormal.png"
...
#define SMOOTHNESS_MAP_FILE "bodysmoothness.png"
...
#define OCCLUSION_MAP_FILE "bodyocclusion.png"
...
#define CUSTOM_A_MAP_FILE "5.png"
...
#define CUSTOM_B_MAP_FILE "bodyskin.png"
#define SSS_SKIN_TRANSMITTANCE(x) exp((1 - saturate(x)) * float3(-8, -40, -64))

const float3 customB = SSS_SKIN_TRANSMITTANCE(5.0);
